/************************************************************************************
 *                                                                                  *
 *   MIGRACIÓN: 20260225120000_update_log_changes_to_is_deleted.sql               *
 *   CORRECCIÓN: ACTUALIZAR DETECCIÓN DE SOFT DELETE A 'is_deleted'                *
 *                                                                                  *
 ************************************************************************************/
...
BEGIN
  ...
  IF (TG_OP = 'UPDATE') THEN
    ...
    -- Actualizado para usar is_deleted según el estándar del proyecto
